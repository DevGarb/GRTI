...
export const menuItems: MenuItem[] = [
  ...
  { key: "op-cadastros", label: "Cadastros", icon: Users, path: "/op/cadastros", orgSlugs: ["operacional"], tooltip: "Cadastros do módulo Operacional: motoristas, empresas e veículos" },
  { key: "op-entregas", label: "Entregas", icon: Truck, path: "/op/entregas", orgSlugs: ["operacional"], tooltip: "Controle de entregas externas" },
];
