    ...
    <BentoTile accent="blue" grid>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <div className="h-9 w-9 rounded-md flex items-center justify-center border border-[hsl(var(--tv-accent-blue)/0.35)] bg-[hsl(var(--tv-accent-blue)/0.08)]">
            <Filter className="h-5 w-5 text-[hsl(var(--tv-accent-blue))]" strokeWidth={1.75} />
          </div>
          <div>
            <div className="text-[12px] font-semibold uppercase tracking-[0.22em] text-[hsl(var(--tv-text-dim))]">Funil Operacional</div>
            <div className="text-lg font-semibold text-[hsl(var(--tv-text))]">Visão geral do fluxo de tickets</div>
          </div>
        </div>
